...
def KNN_improved():
    ...
    #for plotting feature importance score
...
if __name__ == '__main__':
    ...
    print('MODEL : KNN ')
    KNN1 = KNN(data, labels, X_train, X_test, y_train, y_test, features='original')
    KNN2 = KNN(data, labels, X_train, X_test, y_train, y_test, features='reduced')
    accuracy = KNN_improved()s
